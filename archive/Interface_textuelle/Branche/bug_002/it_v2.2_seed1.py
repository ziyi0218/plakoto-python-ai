...
#    - deplacer_pion(plateau, origine, destination, joueur)
#    - check_victoire(plateau, joueur)
#    - board_signature(board)
#    - generate_macro_moves(board, dice, current_player)  
#    - is_move_prefix_in_macro_moves(board, dice, current_player, player_move)
#    - gestion_commande(cmd, plateau, joueur, dice)

#------------------------------------------------------------------------------------

# Les fonctions ajoutées:
#    - in_home_board(pos, joueur)
#    - all_in_home(plateau, joueur)
#    - bearing_off_possible(plateau, origine, dice_value, joueur)
#    - existe_pion_plus_lointain(plateau, joueur, origine)
#    - bearing_off(plateau, origine, joueur)
#    - score_macro_move(macro_move)
#    - filter_max_pratique(macro_dict)
